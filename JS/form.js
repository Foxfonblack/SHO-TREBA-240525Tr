...
const contactUsPageForm = document.querySelector(
...
const contactUsFormCloseBtn = document.querySelector(
  ".contact-us-form-close-btn"
);
const contacUsNotifWrapper = document.querySelector(
