// JS/filters.js
import { convectors } from './data.js';
  ...
  items.forEach(item => {
    ...
    li.innerHTML = `
      ...
      <div class="buttons-wrapper">
        ...
        <a href="/productConv.html?id=${item.id}" class="item-button detail">ДЕТАЛЬНІШЕ</a>
      </div>
    `;
...
function onAddToCartClick(event) {
  ...
  const item = convectors.find(i => i.id === id);
